...
- [ ] Backups automatiques PostgreSQL (cron + stockage distant)
- [ ] CI/CD via GitHub Actions (build en local, déploiement automatique sur push)
- [ ] Couper Heroku une fois la prod validée
- [ ] Écrire un playbook Ansible pour reproduire ce setup
